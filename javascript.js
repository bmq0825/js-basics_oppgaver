...
let username = "bmq0825";
const age = 28;
const hasPets = false;
const isLoggedIn = true;
const hobbies = ["coding", "filmmaking", "volleyball", "gaming", "traveling"];
...
let totalBoxes = totalGoods / goodsPerBox; // 5
totalGoods += 5; // 15
totalGoods--; // 14
totalGoods *= 3; // 42
...
if (userName.trim() !== "" && userAge >= 18 && !userIsBlocked) {
  userIsLoggedIn = true;
  goToPage = "/home";
